...
public class ItClinicalExercise {

    public static String extractUpper(String input, int n, boolean includeSymbol, boolean printCount) {
    ...
    public static String getUpper(String input, int n) {
